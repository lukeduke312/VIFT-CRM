...
function ic(name, size = 18) {
  ...
  const p = {
    ...
    'user-cog':      '<circle cx="18" cy="15" r="3"/><path d="M18 9a3 3 0 1 0 0-6 3 3 0 0 0 0 6z" style="display:none"/><path d="M10 21v-2a4 4 0 0 0-4-4H4"/><circle cx="8" cy="7" r="4"/><path d="m21.7 16.4-.9-.3"/><path d="m15.2 13.9-.9-.3"/><path d="m16.6 18.7.3-.9"/><path d="m19.1 12.2.3-.9"/><path d="m19.6 18.7-.4-1"/><path d="m16.8 12.3-.4-1"/><path d="m14.3 16.6 1-.4"/><path d="m20.7 13.8 1-.4"/>',
  ...
  const d = p[name];
  if (!d) return `<svg ${s}><text y="16" font-size="12">${name.slice(0,2)}</text></svg>`;
